          ...
          <section className="flex flex-col gap-3">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-0.5 text-xs leading-snug text-slate-500">Subí tus fotos de progreso para que tu coach siga tu evolución.</div>
              </div>
            ...
            {/* "Mi progreso" solo se ofrece acá cuando NO está el módulo de arriba
                (que ya tiene "Ver detalle"). Evita la card duplicada sin perder el
                acceso a /mi-panel/progreso para quien todavía no tiene datos. */}
            {!progress && (
              <Link
                to="/mi-panel/progreso"
                className="group flex items-center gap-4 rounded-2xl border border-white/[0.06] bg-surface-800 p-5 transition-all hover:-translate-y-0.5 hover:border-accent/25 hover:bg-surface-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/60"
